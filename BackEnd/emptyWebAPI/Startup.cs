...
namespace TeamGuenonWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<TeamGuenonContext>(options => options.UseSqlServer(Configuration.GetConnectionString("LocalConnection")));
            //services.AddDbContext<TodoContext>(options => options.UseInMemoryDatabase("lol"));
